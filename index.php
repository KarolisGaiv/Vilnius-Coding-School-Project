...
<div class="startPage">
  ...
  <div class="homeMiddle">
    <div class="row">
      ...
      <div class="col s4">
        <img src="https://picsum.photos/300/300" alt="Left Picture">
      ...
      <div class="col s4">
        <img src="https://picsum.photos/301/300" alt="Middle Picture">
        <p class="introLabels">Some text</p>
        <a class="btn" href="contacts.php">Button</a>
      ...
      <div class="col s4">
        <img src="https://picsum.photos/302/300" alt="Right Picture">
        <p class="introLabels">Some text</p>
        <a class="btn" href="contacts.php">Button</a>
